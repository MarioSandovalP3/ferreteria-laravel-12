...
return [
    'expected_date_after_request' => 'La fecha esperada debe ser igual o posterior a la fecha de solicitud',
    'request_date_not_too_old' => 'La fecha de solicitud no puede ser mayor a 1 año en el pasado',
    'request_date_not_future' => 'La fecha de solicitud no puede ser futura',
    
    // Purchase Quotations validation messages
    'supplier_required' => 'El proveedor es obligatorio',
    'supplier_not_exist' => 'El proveedor seleccionado no existe',
    'request_date_required' => 'La fecha de solicitud es obligatoria',
    'request_date_must_be_date' => 'La fecha de solicitud debe ser una fecha válida',
    'expected_date_must_be_date' => 'La fecha esperada debe ser una fecha válida',
    'at_least_one_product_required' => 'Se requiere al menos un producto',
    'product_required_all_items' => 'El producto es obligatorio para todos los artículos',
    'product_not_exist' => 'El producto seleccionado no existe',
    'quantity_required' => 'La cantidad es obligatoria',
    'quantity_min_one' => 'La cantidad debe ser al menos 1',
    'quantity_max_999999' => 'La cantidad no puede exceder 999,999',
    'quoted_price_required' => 'El precio cotizado es obligatorio para todos los productos',
    'quoted_price_must_be_greater_than_zero' => 'El precio cotizado debe ser mayor que cero',
    'item_missing_quoted_price' => 'El producto :item no tiene precio cotizado',
    'tax_rate_max_100' => 'La tasa de impuesto no puede exceder 100%',
    'tax_rate_not_negative' => 'La tasa de impuesto no puede ser negativa',
    ...
    */
    ...
    'phone_format' => 'Usa el formato internacional, por ejemplo: +34 600 123 456.',
    'email_format' => 'El campo debe ser una dirección de correo electrónico válida.',
    ...
    | convención "attribute.rule" para nombrar las líneas. Esto permite especificar
    | rápidamente una línea de idioma personalizada específica para una regla de atributo dada.
    |
    */
